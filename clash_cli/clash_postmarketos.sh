...
config_file="$HOME/.config/clash/test.yml"
...
init_proxy() {
    ...
    log "Setting system-wide proxy settings..."
...
# Function to set the system proxy to none
set_system_proxy_none() {
    log "Setting system proxy to none..."
    log "System proxy set to none."
}
...
display_help() {
    ...
    echo "  noproxy      Set the system proxy to none"
