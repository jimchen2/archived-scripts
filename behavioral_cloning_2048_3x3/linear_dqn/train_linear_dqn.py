...
from linear_dqn.reward_calculator import RewardCalculator
from linear_dqn import DQN
from linear_dqn.replay_buffer import ReplayBuffer
from linear_dqn.utils import optimize_model, soft_update
...
def train_dqn(env, reward_calc, num_episodes):
    policy_net = DQN(COL_ROW_2048=COL_ROW_2048).to(device)
    target_net = DQN(COL_ROW_2048=COL_ROW_2048).to(device)
