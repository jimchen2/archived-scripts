...
async function callLLM({ 
  apiKey, 
  model = 'gemini-3.5-flash', // Updated to a stable model name, adjust as needed
  messages, 
  ...
  try {
    ...
    const payload = {
      ...
      generationConfig: {
        // Only include thinkingConfig if the model actually supports it, otherwise Gemini might error
    ...
    const res = await fetch(url, {
      ...
      headers: {
        ...
        'x-goog-api-key': process.env.GEMINI_API_KEY || apiKey
      },
